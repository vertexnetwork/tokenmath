...
To see this exact prompt scored against every supported model, sorted by total cost, paste it into the [home calculator](/#calculator) and toggle **Compare across all models**. For long-context prompts the comparison view is the fastest way to see whether GPT-4.1 Mini or Gemini 2.5 Flash wins on your specific input.
